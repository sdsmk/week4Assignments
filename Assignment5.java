...
public class Assignment5 {
	 public static void main(String[] args) {
		 ...
		 Employee manager1=new Manager("mgr1",25000);
		  ...
		  dir1.add(gManager);
		  dir1.print();
		  //manager1.add(gManager);
		  //dir1.add( new Developer("ldev",19000));
		 double m=manager1.getCosting();
		 double g=gManager.getCosting();
		  //System.out.println("Designation: "+gManager.getDesignation());
		  //System.out.println("Employees reporting to director directly/indirectly salary was: "+ dir1.getCosting());
		  //System.out.println("manager1: "+ gManager.getCosting());
		  //System.out.println("manager1: "+ manager1.getCosting());
		  System.out.println("Employees reporting to director directly/indirectly salary sum was:"+ (m+g));
